...
insert into point(x,y,z,transitpoint) values(1,0,0,1);
insert into point(x,y,z,transitpoint) values(1,1,0,0);
insert into point(x,y,z,transitpoint) values(1,2,0,0);
insert into point(x,y,z,transitpoint) values(2,2,0,1);
insert into point(x,y,z,transitpoint) values(4,3,0,1);
