...
insert into point(pointID, x,y,z,transitpoint) values(2,1,1,0,0);
insert into point(pointID, x,y,z,transitpoint) values(3,1,2,0,0);
insert into point(pointID, x,y,z,transitpoint) values(4,2,2,0,1);
insert into point(pointID, x,y,z,transitpoint) values(5,4,3,0,1);
